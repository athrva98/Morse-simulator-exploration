...
class DepthCameraPose:
    def _superIndex(self):
        self.num_robots_per_senv = config.num_robots_per_senv
        self.sIdx = int(np.floor(self.robot_number//self.num_robots_per_senv)) 
    def __init__(self,robot_number, depth_camera_port, pose_port):
        ...
        #self.sIdx = read_current_super_index()
        self._superIndex()
    ...
    def points_cloud_update(self,plot_obj, image_number, write_data = True):
        """
