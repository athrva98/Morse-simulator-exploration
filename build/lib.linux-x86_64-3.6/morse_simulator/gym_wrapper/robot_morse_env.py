...
class RobotMorseEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.dcam = DepthCamera.DepthCameraPose(robot_number = 0, pose_port = config.pose_port,
                                                depth_camera_port = config.depthcamera_port)
    ...
    def close(self):
        ...
        config.close(config.child_processes) # kills all the child processes.
    
    
    def _update_episode(self):
        self._publish_reward_topic(self.cumulated_episode_reward,
                                  self.episode_num)
        config.episode_reward = self.cumulated_episode_reward
        self.episode_num += 1
        self.cumulated_episode_reward = 0
    ...
    def _publish_reward_topic(self, reward, episode_number = 1):
        ...
        config.status_dict = self.reward_msg
